  ...
  return (
    <Link href={`/films/${film.episode_id}`}>
        ...
        <div className="relative rounded-3xl shadow-xl overflow-hidden m-5 cursor-pointer">
          <div className="absolute top-0 left-0 right-0 flex justify-between items-center px-4 py-2 bg-black-opacity-80">
            <span className="text-white font-orbitron">{t('episode')}</span>
